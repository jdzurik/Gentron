    ...
    render() {
        return (React.createElement(metro_1.Cell, { className: "h-100" },
            React.createElement(metro_1.Grid, { className: "w-100 h-100 p-3" },
                React.createElement(NavViewContentHeaderRow_1.default, { iconClassName: "mif-embed2", title: this.props.Template.Name }),
                React.createElement(metro_1.Row, { className: "mt-2 mb-2" },
                    React.createElement(metro_1.Cell, null,
                        React.createElement(metro_1.LinkButton, { buttonText: "View All Engine Templates", iconClassName: "mif-arrow-left", linkTo: `/engines/manage/${this.props.match.params.engineid}` }))),
