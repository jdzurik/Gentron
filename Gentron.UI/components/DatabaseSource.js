                    ...
                    React.createElement("div", { className: "h-100 w-100" },
                        React.createElement(metro_1.Row, null,
                            ...
                            React.createElement(metro_1.Cell, { colSpan: 8 },
                                React.createElement(metro_1.FileInput, { onFilePathChange: (value) => this.handleScriptFileNameChange(this.props.DatabaseSource, value) }))),
                        React.createElement(metro_1.Row, { className: "h-100 mt-1" },
                            React.createElement(metro_1.Cell, { className: "h-100" },
                                React.createElement(react_monaco_editor_1.default, { language: "sql", value: this.props.DatabaseSource.Script.Contents || (() => { }).toString(), options: {}, onChange: console.log, editorDidMount: () => { } })))),
                    React.createElement("div", { className: "h-100 w-100" },
