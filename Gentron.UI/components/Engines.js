    ...
    Engines.prototype.render = function () {
        ...
        return (React.createElement(metro_1.Cell, { className: "h-100" },
            React.createElement(metro_1.Grid, { className: "w-100 h-100 p-3" },
                React.createElement(NavViewContentHeaderRow_1.default, { iconClassName: "mif-http", title: "Template Engines" }),
                    ...
                    React.createElement("tbody", null,
                        React.createElement("tr", null,
                            React.createElement("td", null,
                                React.createElement("button", { className: "button", onClick: this.handleAddEngineClick.bind(this) }, "Add Source")),
                            React.createElement("td", null, " "),
                            React.createElement("td", null, " ")),
