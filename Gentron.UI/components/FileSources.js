...
var FileSources = (function (_super) {
    ...
    FileSources.prototype.handleAddSourceClick = function () {
        var source = new Gentron_Library_1.FileSource();
        source.Name = "FileSource" + this.props.FileSources.length;
        this.props.addOrUpdateFileSource(source);
    };
    FileSources.prototype.handleRemoveSourceClick = function (source) {
                ...
                React.createElement("table", { className: "table striped table-border mt-4" },
                    ...
                    React.createElement("tbody", null,
                        React.createElement("tr", null,
                            ...
                            React.createElement("td", null, " "),
                            React.createElement("td", null, " ")),
                        this.props.FileSources.map(function (source, i) {
...
function mapStateToProps(state) {
    var _hash = hash(state.PackageSettings.FileSources);
    return {
