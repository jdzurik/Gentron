                ...
                React.createElement(metro_1.Row, { className: "mb-2" },
                    ...
                    React.createElement(metro_1.Cell, { colSpan: 9 },
                        React.createElement("div", { className: "input" },
                            React.createElement("input", { type: `text`, placeholder: `Local Package Folder`, value: this.props.LocalPackageFolder, onChange: (ev) => this.props.addOrUpdateLocalPackageFolder(ev), "data-role": `input`, "data-role-input": true }),
